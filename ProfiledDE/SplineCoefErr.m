...
%SplineCoefErr:  error and jacobian calculations for fitting a spline to 
% data with a DE penalty
% 
% INPUTS:
% 
...
fvals   = cell2mat(feval_check(fn.fn,  quadvals(:,1),fd_cell,pars, ...
                               fn_extras));

dfvals  =          feval_check(fn.dfdx,quadvals(:,1),fd_cell,pars, ...
                               fn_extras);
...
if nargout > 1
    ...
    % Derivatives of penalty wrt coefs:
