...
f2 = y2*(p9*p12*y1/(p10 + y1) - p3*p13*(y4 + y5)/(p15 + Qs) - p6);
f3 = y3*(p9*p12*y1/(p11 + y1) - p4*p13*(y4 + y5)/(p15 + Qs) - p6);
f4 = y4*(p14*p13*Q/(p15 + Qs) - (p6 + p7 + p8));
f5 = p8*y4 - (p6 + p7)*y5;
...
%  define second derivatives of five functions wrt five y's and 2 Q's
