...
% proc.qpts      = mids;                  % Quadrature points
% proc.weights   = ones(5,1).*lambda;     % Quadrature weights 
% proc.names     = ChemoVarNames;         % Variable names
% proc.parnames  = ChemoParNames;         % Parameter names

% proc.more           = make_findif_ode;       % Finite differencing
Chemotrans          = make_id;
logTransStruct      = Chemotrans;
...
proc.more.more.more = @chemo_fun;         % ODE function
