function [newpars,DEfd] = Profile_GausNewt(pars,lsopts,DEfd,fn,lambda, ...
    Ycell,Tcell,wts,alg,lsopts2,fn_extras,pen,dpen,pen_extras)
%Profile_GausNewt: Gauss-Newton algorithm for use with ProfileErr.
%
% INPUTS:
%
...
[res0,Dres,DEfd] = ProfileErr(pars,DEfd,fn,lambda,Ycell,Tcell,wts,alg, ...
