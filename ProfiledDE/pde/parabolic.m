...
%  -----------------------------------------------------------------------
%            if d, rtol and atol are not input but c, a and f are
%  -----------------------------------------------------------------------
...
elseif nargin==7 || nargin==8 || nargin==9
  ...
  error('PDE:parabolic:nargin', ...
        'Number of input arguments must be between 7 and 12.')
end
